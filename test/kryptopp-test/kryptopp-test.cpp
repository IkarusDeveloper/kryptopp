...
int main()
{
	try
	{
		...
		// using the EncryptString we are also testing binary Encrypt
		{
		...
		// MIX encryption is also testing RSA binary encryption internally used by MIX
		{
			// getting random key and input memory
			const auto rsaPair = KryptoPP::RSA::GenerateRandomKeyPair();
